    ...
    std::vector<PointPtr>& trash_points)
{
  ...
  for(const FramePtr& ref_frame : visible_kfs)
  {
    int sum_feature = ref_frame->num_features_;
    int outlier_feature = 0;
    ...
    // std::cout << "ref_frame id: " << ref_frame->id() 
    //           << ", sum_feature: " << sum_feature 
    //           << ", outlier_feature: " << outlier_feature 
    //           << ", valid_feature: " << sum_feature - outlier_feature 
    //           << std::endl;
  }
